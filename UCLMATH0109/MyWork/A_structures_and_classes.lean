...
@[ext]  -- creates lemma that proves that points in the plane are the same i.e the x/y coordinates of the points are equal
...
by
  ext  -- creates cases for adding 0 in x/y coordinates.
...
--following exact statements work because Plane is an additive commutative group
/-
