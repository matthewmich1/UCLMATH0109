...
example (b : α) : b = 8 * b:=
by
  rw [h2id b, hmul_assoc, h2id b, hmul_assoc, h2id b, hmul_assoc, ←h2id b, ←h2id b, ←hmul_assoc 8, ←h2id]
...
by
  rw [h2id b, hmul_assoc, h2id b, hmul_assoc, ←h2id b, ←h2id b]
...
by
  ...
  | zero =>
    rfl
  | succ n ih =>
    rw [pow_succ, ←hmul_assoc, ←h2id b, ←ih, ←h2id b]
